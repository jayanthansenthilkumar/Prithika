...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-14">
      ...
      {/* Hero */}
      <section className="pt-24 pb-16 border-b-[3px] border-foreground bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-foreground mb-6 tracking-tighter font-heading uppercase leading-tight">
              Let's build something <span className="bg-background px-2 border-[3px] border-foreground rounded-none shadow-[4px_4px_0px_0px_var(--color-foreground)] inline-block">together.</span>
            </h1>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            {/* Form */}
            <div className="bg-background border-[3px] border-foreground shadow-brutal-lg rounded-none overflow-hidden h-full flex flex-col">
              ...
              {submitted ? (
                <div className="p-8 md:p-12 text-center flex-grow flex flex-col items-center justify-center">
                  <div className="w-20 h-20 bg-primary border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] rounded-none mb-8 flex items-center justify-center animate-bounce">
                ...
                <div className="p-8 md:p-12 space-y-8 flex-grow flex flex-col">
                  <div className="space-y-3">
                    ...
                    <Input id="name" placeholder="John Doe" className="rounded-none font-mono font-bold text-sm border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] focus-visible:ring-0 focus-visible:shadow-[6px_6px_0px_0px_var(--color-foreground)] transition-shadow h-12" />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Input id="email" type="email" placeholder="john@example.com" className="rounded-none font-mono font-bold text-sm border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] focus-visible:ring-0 focus-visible:shadow-[6px_6px_0px_0px_var(--color-foreground)] transition-shadow h-12" />
                  </div>
                  ...
                  <div className="space-y-3 flex-grow flex flex-col">
                    ...
                    <textarea 
                      ...
                      className="w-full rounded-none font-mono font-bold text-sm border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] focus:outline-none focus:shadow-[6px_6px_0px_0px_var(--color-foreground)] transition-shadow px-4 py-3 resize-none flex-grow"
                    />
                  </div>
                  
                  <Button 
                    onClick={() => setSubmitted(true)}
                    className="w-full bg-primary border-[3px] border-foreground text-foreground rounded-none font-black font-heading text-lg uppercase shadow-brutal hover:-translate-y-1 hover:shadow-brutal-lg transition-all h-14 mt-4"
                  >
                    Send Message
                  </Button>
                </div>
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-4xl font-black text-foreground mb-6 font-heading uppercase tracking-tighter">Connect <span className="bg-primary px-2 border-[3px] border-foreground rounded-none shadow-[2px_2px_0px_0px_var(--color-foreground)]">Directly</span></h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <a href="tel:+919787673783" className="block group">
                  <div className="bg-background border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] rounded-none p-6 group-hover:-translate-y-1 group-hover:-translate-x-1 group-hover:shadow-[8px_8px_0px_0px_var(--color-foreground)] transition-all h-full">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 border-[3px] border-foreground rounded-none bg-primary shadow-[2px_2px_0px_0px_var(--color-foreground)]">
                        <Phone className="w-5 h-5 text-foreground" />
                      </div>
                      <h3 className="text-xl font-black text-foreground font-heading uppercase">Phone</h3>
                    </div>
                    <p className="text-sm font-mono font-bold text-foreground bg-primary rounded-none inline-block px-2 border-[3px] border-foreground">+91 9787673783</p>
                  </div>
                </a>
                ...
                <a href="mailto:kpprithika75@gmail.com" className="block group">
                  <div className="bg-background border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] rounded-none p-6 group-hover:-translate-y-1 group-hover:-translate-x-1 group-hover:shadow-[8px_8px_0px_0px_var(--color-foreground)] transition-all h-full">
                    ...
                    <p className="text-sm font-mono font-bold text-foreground bg-primary rounded-none inline-block px-2 border-[3px] border-foreground break-all">kpprithika75@gmail.com</p>
                  </div>
                </a>
                ...
                <a href="https://www.linkedin.com/in/prithikakannan" target="_blank" rel="noopener noreferrer" className="block group">
                  <div className="bg-background border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] rounded-none p-6 group-hover:-translate-y-1 group-hover:-translate-x-1 group-hover:shadow-[8px_8px_0px_0px_var(--color-foreground)] transition-all h-full">
                    ...
                    <p className="text-sm font-mono font-bold text-foreground bg-primary rounded-none inline-block px-2 border-[3px] border-foreground break-all">prithikakannan</p>
                  </div>
                </a>

                <a href="https://github.com/prithikakannan" target="_blank" rel="noopener noreferrer" className="block group">
                  <div className="bg-background border-[3px] border-foreground shadow-[4px_4px_0px_0px_var(--color-foreground)] rounded-none p-6 group-hover:-translate-y-1 group-hover:-translate-x-1 group-hover:shadow-[8px_8px_0px_var(--color-foreground)] transition-all h-full">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 border-[3px] border-foreground rounded-none bg-primary shadow-[2px_2px_0px_0px_var(--color-foreground)]">
