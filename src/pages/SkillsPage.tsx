    ...
    >
      ...
      <div className="mb-16 max-w-3xl">
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-black/5 dark:border-white/10 w-fit mb-6">
          ...
          <span className="text-sm font-medium tracking-wide text-zinc-900 dark:text-zinc-100">~/skills</span>
        </motion.div>
        ...
        <motion.p variants={itemVariants} className="text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed text-balance transition-colors">
        ...
        {skillCategories.map((category, idx) => (
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="w-16 h-16 rounded-2xl glass flex items-center justify-center bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10">
                {category.icon}
              </div>
              <h2 className="text-3xl font-bold text-zinc-900 dark:text-white transition-colors">{category.title}</h2>
            </div>
